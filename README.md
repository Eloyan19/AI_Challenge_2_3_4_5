...
Пользователь отправляет сообщение
  ...
  «Отклонить»: TaskState: REPLANNING
...
├── dismissTaskState()         — прямой сброс в Idle + clearTaskPlan
...
- Room v7 (chat_messages, summary, sticky_facts, branches, working_memory, long_term_memory, user_profiles, task_plan)
